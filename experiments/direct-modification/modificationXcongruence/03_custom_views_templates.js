  ...
  const view = {
      ...
      render: function(CT, magpie) {
          ...
          <section class="magpie-text-container">
            ...
            <p class="magpie-view-text" style="font-family:Courier New, Courier"> Please note: There will be multiple posted versions of this HIT (name:<b> Objects - 303</b>) throughout the next few days.
