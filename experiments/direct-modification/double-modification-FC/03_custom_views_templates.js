...
const custom_forced_choice = function(config, startingTime) {
  const view = {
    ...
    render: function(CT, magpie, startingTime) {
      ...
      ${config.data[CT].paraphrase}<br/><br/>
      <input type='radio' name='fc' id='o1' value=${config.data[CT].option1} />
      <label for='o1'>${config.data[CT].option1}</label>
      <input type='radio' name='fc' id='o2' value=${config.data[CT].option2} />
      <label for='o2' >${config.data[CT].option2}</label>
      </div>
...
//            <textarea name='textbox-input' rows=1 cols=15 class='textbox-input'/>
        ...
        $("input[name=fc]").on("change", function() {
...
// record trial data
        $("#next").on("click", function() {
            ...
            let trial_data = {
                ...
                response: $("input[name=fc]:checked").val(),
                RT: RT
            };
