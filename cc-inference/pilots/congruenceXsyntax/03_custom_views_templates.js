...
// render the pre-defined labeling view
      ...
      <section class="magpie-text-container">
        <p class="magpie-view-question">${config.data[CT].train.text}</p>
      </section>
    ...
    <div style="width:100%;">
     <div style="width:50%;height:400px;float:left;position:relative;align:center;">
        <div style="position:absolute;bottom:0;right:20px;">
          <div class="picture"  align="center" >
            <img src="${config.data[CT].train.picture1}">
          </div>
          <div  class='magpie-view-answer-container'>
            <p id='1' class='magpie-view-text'>${config.data[CT].train.question1}
              <textarea id='textbox-input1' rows=1 cols=15 class='textbox-input' readonly>${config.data[CT].train.default1}</textarea>
            </p>
          </div>
        </div>
    </div>
    <div style="width:50%;height:400px;float:right; position:relative;align:center;">
      <div style="position:absolute;bottom:0;left:20px;">
          <div  class="picture" align="center" >
            <img src="${config.data[CT].train.picture2}">
          </div>
          <div class='magpie-view-answer-container' >
            <p id='2' class='magpie-view-text'>${config.data[CT].train.question3}
              <textarea id='textbox-input2' rows=1 cols=15 class='textbox-input'readonly>${config.data[CT].train.default2}</textarea>
            </p>
          </div>
      </div>
      </div>
  ...
  const view = {
      ...
      render: function(CT, magpie) {
          ...
          <section class="magpie-text-container">
            ...
            <p class="magpie-view-text" style="font-family:Courier New, Courier"> Please note: There will be multiple posted versions of this HIT (name:<b> Objects in Context - 202</b>) throughout the next few days.
