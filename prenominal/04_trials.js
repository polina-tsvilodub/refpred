...
const main_trials = {
    dogs1:   {
            ...
            pic_spec: picture[0],
            text: "You and your friend see another " + items.dogs1[target_size[0]].referent[1] + " (not pictured), and your friend says: <br/><b>" + items.dogs1[target_size[0]].utterance1 + items.dogs1[target_size[0]].picture[picture[0]].adj + items.dogs1[target_size[0]].referent[referent[0]] + items.dogs1[target_size[0]].utterance2  + ".</b>",
            ref_spec: referent[0],
    ...
    dogs2:    {
            ...
            pic_spec: picture[1],
            text: "You and your friend see another " + items.dogs2[target_size[1]].referent[1] + " (not pictured), and your friend says: <br/><b>" + items.dogs2[target_size[1]].utterance1 + items.dogs2[target_size[1]].picture[picture[1]].adj + items.dogs2[target_size[1]].referent[referent[1]] + items.dogs2[target_size[1]].utterance2 + ".</b>",
            ref_spec: referent[1],
            question: "What do you think your friend meant?",
    ...
    birds:    {
            ...
            pic_spec: picture[2],
            text: "You and your friend see another "+ items.birds[target_size[2]].referent[1] + " (not pictured), and your friend says: <br/><b>" + items.birds[target_size[2]].utterance1 + items.birds[target_size[2]].picture[picture[2]].adj + items.birds[target_size[2]].referent[referent[2]] + items.birds[target_size[2]].utterance2 + ".</b>",
            ref_spec: referent[2],
            question: "What do you think your friend meant?",
  ...
  fish:      {
            ...
            pic_spec: picture[3],
            text:"You and your friend see another "+ items.fish[target_size[3]].referent[1] + " (not pictured), and your friend says: <br/><b>" + items.fish[target_size[3]].utterance1 + items.fish[target_size[3]].picture[picture[3]].adj + items.fish[target_size[3]].referent[referent[3]] + items.fish[target_size[3]].utterance2 + ".</b>",
            ref_spec: referent[3],
  ...
  flowers:      {
            ...
            pic_spec: picture[4],
            text: "You and your friend see another "+ items.flowers[target_size[4]].referent[1] + " (not pictured), and your friend says: <br/><b>" + items.flowers[target_size[4]].utterance1 + items.flowers[target_size[4]].picture[picture[4]].adj + items.flowers[target_size[4]].referent[referent[4]] + items.flowers[target_size[4]].utterance2 + ".</b>",
            ref_spec: referent[4],
            question: "What do you think your friend meant?",
    ...
    trees:    {
            ...
            pic_spec: picture[5],
            text: "You and your friend see another "+ items.trees[target_size[5]].referent[1] + " (not pictured), and your friend says: <br/><b>" + items.trees[target_size[5]].utterance1 + items.trees[target_size[5]].picture[picture[5]].adj + items.trees[target_size[5]].referent[referent[5]] + items.trees[target_size[5]].utterance2 + ".</b>",
            ref_spec: referent[5],
            question: "What do you think your friend meant?",
