...
Examining the syntax interaction in the context of the N~vs.~\emph{one} contrast, we found that $\rlgetnum{expt3_3way_full_contrasts_wProbs.csv}{Rowname}{syntax_sub_v_one}{prob_lt_0}{1}$\% of the posterior distribution of subordinate-N~vs.~\emph{one} x Syntax interaction was less than 0 ($\beta = \rlgetnum{expt3_3way_full_contrasts_wProbs.csv}{Rowname}{syntax_sub_v_one}{mean}{2} [\rlgetnum{expt3_3way_full_contrasts_wProbs.csv}{Rowname}{syntax_sub_v_one}{X.95.}{2}, \rlgetnum{expt3_3way_full_contrasts_wProbs.csv}{Rowname}{syntax_sub_v_one}{u95.}{2}]$) whereas only $\rlgetnum{expt3_3way_full_contrasts_wProbs.csv}{Rowname}{syntax_basic_v_one}{prob_gt_0}{1}$\% of the posterior of the basic-N~vs.~\emph{one} X Syntax interaction was greater than 0 ($\beta = \rlgetnum{expt3_3way_full_contrasts_wProbs.csv}{Rowname}{syntax_basic_v_one}{mean}{2} [\rlgetnum{expt3_3way_full_contrasts_wProbs.csv}{Rowname}{syntax_basic_v_one}{X.95.}{2}, \rlgetnum{expt3_3way_full_contrasts_wProbs.csv}{Rowname}{syntax_basic_v_one}{u95.}{2}]$), a suggestion of a difference between how reference and predication goals trade-off for the basic-~vs.~subordinate-level nouns in our basic- and subordinate-level contexts, indicating the importance of the referential utility of the respective noun.\footnote{To further explore the Noun x Syntax interaction, we built a regression model that assumed only a fixed-effect of context. Under this model, the difference between how the subordinate~vs.~basic Ns were treated in different syntactic positions was even more pronounced. In particular, $\rlgetnum{expt3_2way_full_contrasts_wProbs.csv}{Rowname}{syntax_sub_v_one}{prob_lt_0}{1}$\% of the sub N~vs.~\emph{one} x Syntax is less than 0.}
...
At the same time, in the subordinate-level context, we did observe a higher rate of basic-level comparison class inferences for basic-level nouns:  since the context makes the basic-level noun referentially uninformative, listeners may reason that the usage of the noun was to set the comparison class. \pt{new info}
