...
// each context is called
    ...
    dogs1:  [ // big target of each context is first
      {
            ...
            pic_spec: items.dogs1_b[cont_order1[0]].picture[0].condition, // if 0, basic, if 1 subordinate context
            text: "Your friend runs far ahead of you, and you see him in the distance: ",
            pic: items.dogs1_b[cont_order1[0]].target,
            utterance: "Your friend says: </br><b>" + items.dogs1_b[cont_order1[0]].utterances[syntactic_cond[0]][referent[0]] + "</b>",
            np_type: items.dogs1_b[cont_order1[0]].np_type[referent[0]],
            syntax_condition: items.dogs1_b[cont_order1[0]].syntax_condition[syntactic_cond[0]],
        ...
        // small target of the context is second
        {
            ...
            pic_spec: items.dogs1_s[cont_order1[1]].picture[0].condition,
            text: "Your friend runs far ahead of you, and you see him in the distance: ",
    ...
    dogs2:  [  {
            ...
            pic_spec: items.dogs2_b[cont_order2[0]].picture[0].condition,
            text: "Your friend runs far ahead of you, and you see him in the distance: ",
        ...
        },
        {
            ...
            pic_spec: items.dogs2_s[cont_order2[1]].picture[0].condition,
            text: "Your friend runs far ahead of you, and you see him in the distance: ",
            ...
            np_type: items.dogs2_s[cont_order2[1]].np_type[referent[2]],
            question:  "What do you think your friend meant?",
    ...
    birds:   [ {
            ...
            pic_spec: items.birds_b[cont_order3[0]].picture[0].condition,
            text: "Your friend runs far ahead of you, and you see him in the distance: ",
        ...
        },
        {
            ...
            pic_spec: items.birds_s[cont_order3[1]].picture[0].condition,
            text: "Your friend runs far ahead of you, and you see him in the distance: ",
  ...
  fish:   [   {
            ...
            pic_spec: items.fish_b[cont_order4[0]].picture[0].condition,
            text:"Your friend runs far ahead of you, and you see him in the distance: " ,
        ...
        },
        {
            ...
            pic_spec: items.fish_s[cont_order4[1]].picture[0].condition,
            text:"Your friend runs far ahead of you, and you see him in the distance: " ,
  ...
  flowers:    [  {
            ...
            pic_spec: items.flowers_b[cont_order5[0]].picture[0].condition,
            text:"Your friend runs far ahead of you, and you see him in the distance: ",
        ...
        },
        {
            ...
            pic_spec: items.flowers_s[cont_order5[1]].picture[0].condition,
            text:"Your friend runs far ahead of you, and you see him in the distance: ",
    ...
    trees:   [ {
            ...
            pic_spec: items.trees_b[cont_order6[0]].picture[0].condition,
            text: "Your friend runs far ahead of you, and you see him in the distance: ",
        ...
        },
        {
            ...
            pic_spec: items.trees_s[cont_order6[1]].picture[0].condition,
            text: "Your friend runs far ahead of you, and you see him in the distance: ",
...
// sample a set of warmup trials and the corresponding big and small targets
