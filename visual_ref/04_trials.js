...
const main_trials = {
    ...
    bob: {
          ...
          context_picture: "dog-parade-basic2.png",
          text: "Bob goes on ahead of you. You see the following at the end of the street: ",
          pic: "bob-gd.png",
          utterance: "Your friend says to you: <b>That's a big great dane.</b>",
          question: "What do you think your friend meant?",
          sentence_left: "It is big relative to other "
    },
    dogs1:   {
            context: "You and your friend watch the following:",
...
const trials = [ {x: warmup_trials.dogs1, y:main_trials.dogs1}, {x: warmup_trials.dogs2, y:main_trials.dogs2},
