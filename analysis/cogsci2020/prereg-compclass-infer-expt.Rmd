...
``` {r data}
# read data
d_infer <- read_csv('./../../data/cogsci2020/results_30_prereg-cc-inf.csv')
...
d_infer_main_responseCat.bs %>%
  ...
  facet_grid(~context)  
  ggsave("figs/expt3-cc-inference-revised.pdf", width = 5, height = 3.5)
```
...
write_csv(data.frame(summary(lm.b.infer.fit.by.target)[["fixed"]]) %>%
          ...
          path = "./../../writing/R_results_TeX/expt3_full_brm_revised.csv")
```
...
# compute means and CIs (cogsci stuff, to be removed if the stuff below works fine)
mean(lm.b.infer3way.by.target.fit.samples$sub_v_one)
quantile(lm.b.infer3way.by.target.fit.samples$sub_v_one, probs = c(0.025, 0.975))
mean(lm.b.infer3way.by.target.fit.samples$sub_v_basic)
quantile(lm.b.infer3way.by.target.fit.samples$sub_v_basic, probs = c(0.025, 0.975))
mean(lm.b.infer3way.by.target.fit.samples$basic_v_one) 
quantile(lm.b.infer3way.by.target.fit.samples$basic_v_one, probs = c(0.025, 0.975))

quantile(lm.b.infer3way.by.target.fit.samples$syntax_sub_v_one, probs = c(0.025, 0.975))
quantile(lm.b.infer3way.by.target.fit.samples$syntax_sub_v_basic, probs = c(0.025, 0.975))
mean(lm.b.infer3way.by.target.fit.samples$syntax_basic_v_one)
mean(lm.b.infer3way.by.target.fit.samples$syntax_sub_v_basic)
quantile(lm.b.infer3way.by.target.fit.samples$syntax_basic_v_one, probs = c(0.025, 0.975))
mean(lm.b.infer3way.by.target.fit.samples$syntax_basic_v_one < 0)
mean(lm.b.infer3way.by.target.fit.samples$syntax_sub_v_basic < 0)
quantile(lm.b.infer3way.by.target.fit.samples$context_syntax_sub_v_one, probs = c(0.025, 0.975))
quantile(lm.b.infer3way.by.target.fit.samples$context_syntax_basic_v_one, probs = c(0.025, 0.975))
quantile(lm.b.infer3way.by.target.fit.samples$context_syntax_sub_v_basic, probs = c(0.025, 0.975)) 
```

```{r}
# here is a convenience function to get contrast statistics to easier write the corresponding TeX csv
summarize_sample_vector <- function(samples, name = '') {
    tibble(
      Parameter = name,
      '|95%' = quantile(samples, probs = c(0.025, 0.975))[[1]],
      mean  = mean(samples),
      '95%|' = quantile(samples, probs = c(0.025, 0.975))[[2]]
    )
}
```
...
# polina's revisions 
rbind(
  summarize_sample_vector(lm.b.infer3way.by.target.fit.samples$sub_v_one, 'sub_v_one'),
  summarize_sample_vector(lm.b.infer3way.by.target.fit.samples$sub_v_basic, 'sub_v_basic'),
  summarize_sample_vector(lm.b.infer3way.by.target.fit.samples$basic_v_one, 'basic_v_one'),
  summarize_sample_vector(lm.b.infer3way.by.target.fit.samples$syntax_basic_v_one, 'syntax_basic_v_one'),
  summarize_sample_vector(lm.b.infer3way.by.target.fit.samples$syntax_sub_v_one, 'syntax_sub_v_one'),
  summarize_sample_vector(lm.b.infer3way.by.target.fit.samples$syntax_sub_v_basic, 'syntax_sub_v_basic'),
  summarize_sample_vector(lm.b.infer3way.by.target.fit.samples$context_syntax_basic_v_one, 'context_syntax_basic_v_one'),
  summarize_sample_vector(lm.b.infer3way.by.target.fit.samples$context_syntax_sub_v_one, 'context_syntax_sub_v_one'),
  summarize_sample_vector(lm.b.infer3way.by.target.fit.samples$context_syntax_sub_v_basic, 'context_syntax_sub_v_basic')
) -> lm.b.infer3way.full.contrasts

# not sure how to put these in a csv
mean(lm.b.infer3way.by.target.fit.samples$syntax_basic_v_one < 0)
mean(lm.b.infer3way.by.target.fit.samples$syntax_sub_v_basic < 0)
...
``` {r}
write_csv(lm.b.infer3way.full.contrasts 
          %>% mutate(Rowname = .$Parameter), 
          path = "./../../writing/R_results_TeX/expt3_3way_full_contrasts_revised.csv")
```
...
write_csv(data.frame(lm.b.infer.fit.two.way2.sum.summary[["fixed"]]) %>%
            mutate(Rowname = row.names(.)),
          path = "./../../writing/R_results_TeX/expt3_2_way_full_brm_revised.csv")
```
...
# cogsci stuff, not sure what to keep
mean(lm.b.infer.2way.fit.samples$sub_v_one)
quantile(lm.b.infer.2way.fit.samples$sub_v_one, probs = c(0.025, 0.975))
mean(lm.b.infer.2way.fit.samples$sub_v_one<0)
mean(lm.b.infer.2way.fit.samples$sub_v_basic)
quantile(lm.b.infer.2way.fit.samples$sub_v_basic, probs = c(0.025, 0.975))
mean(lm.b.infer.2way.fit.samples$basic_v_one)
quantile(lm.b.infer.2way.fit.samples$basic_v_one, probs = c(0.025, 0.975))
mean(lm.b.infer.2way.fit.samples$basic_v_one>0)
...
# get contrast stats 
rbind(
  summarize_sample_vector(lm.b.infer.2way.fit.samples$syntax_sub_v_one, 'syntax_sub_v_one'),
  summarize_sample_vector(lm.b.infer.2way.fit.samples$syntax_sub_v_basic, 'syntax_sub_v_basic'),
  summarize_sample_vector(lm.b.infer.2way.fit.samples$syntax_basic_v_one, 'syntax_basic_v_one')
) -> lm.b.infer2way.full.contrasts

# not sure how to put these into a csv:
mean(lm.b.infer.2way.fit.samples$syntax_basic_v_one > 0)
mean(lm.b.infer.2way.fit.samples$syntax_sub_v_one > 0)
```
...
write_csv(
  lm.b.infer2way.full.contrasts 
          %>% mutate(Rowname = .$Parameter), 
          path = "./../../writing/R_results_TeX/expt3_2way_full_contrasts_revised.csv"
)
```

```{r}
# NOT SURE WHAT THE DIFFERENCE IS TO PREVIOUS ONE 
# two-way analysis
