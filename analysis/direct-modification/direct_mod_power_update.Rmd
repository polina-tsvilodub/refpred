...
analyse_power <- tibble(n.subj = 500) %>%
  mutate(
...
analyse_power %>% write_csv(paste("results/direct_mod_power_analysis_1000subj_3_", n_iter, "iter_", n_sim, "sim.csv", sep = ""))
analyse_power_summary %>% write_csv(paste("results/direct_mod_power_analysis_1000subj_3_", n_iter, "iter_", n_sim, "sim_summary.csv", sep = ""))
